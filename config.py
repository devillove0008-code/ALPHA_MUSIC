...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/devillove0008-code/ALPHA_MUSIC.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/sonalibots")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/PURVIUPDATES")
